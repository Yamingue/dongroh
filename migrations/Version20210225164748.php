 ...
 */
final class Version20210225164748 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, articles_id INT DEFAULT NULL, panier_id INT DEFAULT NULL, make_by_id INT DEFAULT NULL, prix INT NOT NULL, confirme_at DATETIME DEFAULT NULL, do_at DATETIME NOT NULL, is_confirme TINYINT(1) DEFAULT NULL, is_deliver TINYINT(1) DEFAULT NULL, INDEX IDX_6EEAA67D1EBAF6CC (articles_id), INDEX IDX_6EEAA67DF77D927C (panier_id), INDEX IDX_6EEAA67D4999C0C5 (make_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
